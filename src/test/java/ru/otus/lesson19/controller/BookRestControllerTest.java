...
public class BookRestControllerTest {
        ...
        public void getAuthoreList_ShouldReturnAuthoreList_WhenCalled(){
            ...
            Mockito.when(authorService.getAllAuthore()).thenReturn(authorDtos);
        ...
        public void getGenreList_ShouldReturnGenreList_WhenCalled(){
            ...
            Mockito.when(genreService.getAllGenre()).thenReturn(genreDtos);
        ...
        public void deleteBookById_ShouldDeleteBookById_WhenCalled(){
            Long id = 1L;
            List<BookDto> bookDtos = new ArrayList<>();
            Mockito.when(bookService.deleteBookById(id)).thenReturn(bookDtos);
        ...
        public void getCommentList_ShouldReturnCommentList_WhenCalled(){
            ...
            Mockito.when(commentService.getAllCommentsByBook(id)).thenReturn(commentDtos);
